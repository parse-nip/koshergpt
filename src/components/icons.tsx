...
export function IconMessageSquare({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconScroll({ className, strokeWidth = 2, ...props }: IconProps & { strokeWidth?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function IconSearchMagnifier({
  className,
  strokeWidth = 2,
  ...props
